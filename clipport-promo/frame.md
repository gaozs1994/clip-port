...
description: >
  ...
  accent, the three-step gray text ladder, Plus Jakarta Sans (display/numerals/chrome) + Plus Jakarta Sans (body),
...
colors:
  ...
  accent-medium: "rgba(194, 65, 12, 0.15)"
  border: "rgba(194, 65, 12, 0.2)"
  card-bg: "rgba(194, 65, 12, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Plus Jakarta Sans body + Plus Jakarta Sans chrome) —
  body:    { fontFamily: "Plus Jakarta Sans", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Plus Jakarta Sans", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Plus Jakarta Sans", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Plus Jakarta Sans", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Plus Jakarta Sans, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Plus Jakarta Sans", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Plus Jakarta Sans", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Plus Jakarta Sans", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Plus Jakarta Sans", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Plus Jakarta Sans", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Plus Jakarta Sans", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Plus Jakarta Sans", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
components:
  ...
  cta-button:
    ...
    textColor: "{colors.bg}"
    rounded: "{radii.pill}"
    typography: "Plus Jakarta Sans 600"
...
- **Fonts** — already set to **Plus Jakarta Sans** (display) / **IBM Plex Mono** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Plus Jakarta Sans** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Plus Jakarta Sans** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Plus Jakarta Sans** (display/numerals/chrome) + **Plus Jakarta Sans** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Plus Jakarta Sans body 0.85cqw muted; Plus Jakarta Sans eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Plus Jakarta Sans `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Plus Jakarta Sans 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Plus Jakarta Sans `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Plus Jakarta Sans label + muted desc + optional
...
blockquote, cite. **Focal** a Plus Jakarta Sans `blockquote` near-black under a 15%-opacity cobalt
...
Plus Jakarta Sans body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Plus Jakarta Sans `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Plus Jakarta Sans 400 muted, line 1.6.
...
- **Type** — Plus Jakarta Sans headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Plus Jakarta Sans body muted line 1.6; ≥1.4cqw floor.
...
- **Plus Jakarta Sans + Plus Jakarta Sans via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
